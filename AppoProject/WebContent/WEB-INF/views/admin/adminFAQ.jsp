...
<body>
				...
				<div class="row FAQ_answer">
					<div class="col-md-12">
						...
						<div class="FAQ_modify">
							<a href="FAQmodifyForm?faqNo=<%=faq.getFaqNo() %>" class="btn btn-info my-1 mr-1 ml-1 px-2 py-1">수정</a>
							<a onclick="return confirm('정말 삭제하시겠습니까?');" href="FAQdelete?faqNo=<%=faq.getFaqNo() %>" class="btn btn-info my-1 mr-1 ml-1 px-2 py-1">삭제</a>
						</div>
					</div>
				</div>
				<hr>
	...
	<script>
		...
		function moreFAQ() {
			...
			$.ajax({
				url : "FAQ?currentPage="+ currentPage,
				type : "get",
				dataType : "json",
