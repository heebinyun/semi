                ...
                <div class="col-sm-8">
                    ...
                    <div class="form-row">
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item">
                            	<!-- 맨처음으로-->
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/notice/list?currentPage=1">&laquo;</a>
                            </li>
                            	<!-- 이전으로 -->
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/notice/list?currentPage=<%= currentPage-1 %>">&lt;</a>
                            </li>
                            <% } %>
                            ...
                            <% for(int p = startPage; p <= endPage; p++){ %>
                           	...
                           	<li class="page-item">
                            	...
                            	<% } else { %>
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/notice/list?currentPage=<%= p %>"><%= p %></a>
                            </li>
                            	<% } %>
                            <% } %>
                            <!-- 다음 페이지로-->
                            ...
                            <!-- 맨끝으로-->
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/notice/list?currentPage=<%= maxPage %>">&raquo;</a>
                            </li>
                            <% } %>
                        </ul>
                    </div>
