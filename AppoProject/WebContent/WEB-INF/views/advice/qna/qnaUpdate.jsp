    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                <!--  폼시작-->
                <form action="<%=request.getContextPath()%>/advice/qna/update?no=<%= qna.getQnaNo() %>" 
                method="post" onsubmit="return validate();">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-10">
                            ...
                            value="<%= qna.getQnaTitle()%>" id="title"
                            name="title">
                        </div>
                    </div>
                    <hr>
                    <div class="form-row">
                        ...
                        name="content" rows="10"><%= qna.getQnaContent() %></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-10 text-center">
                            ...
                            onclick="location.href='<%= request.getContextPath()%>/advice/qna/list'">취소</button>
                        </div>
