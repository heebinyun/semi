                ...
                <div class="col-sm-8">
                    ...
                    <div class="form-row">
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item">
                            	<!-- 맨처음으로-->
                                <a class="page-link" href="search?currentPage=1&searchKey=<%=searchKey %>&searchValue=<%= searchValue %>">&laquo;</a>
                            </li>
                            	<!-- 이전으로 -->
                            <li class="page-item">
                                <a class="page-link" href="search?currentPage=<%= currentPage-1 %>&searchKey=<%=searchKey %>&searchValue=<%= searchValue %>">&lt;</a>
                            </li>
                            <% } %>
                            ...
                            <% for(int p = startPage; p <= endPage; p++){ %>
                           	...
                           	<li class="page-item">
                            	...
                            	<% } else { %>
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/qna/search?currentPage=<%= p %>&searchKey=<%=searchKey %>&searchValue=<%= searchValue %>"><%= p %></a>
                            </li>
                            	<% } %>
                            <% } %>
                            <!-- 다음 페이지로-->
                            ...
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/qna/search?currentPage=<%= currentPage+1 %>&searchKey=<%=searchKey %>&searchValue=<%= searchValue %>">&gt;</a>
                            </li>
                            
                            <!-- 맨끝으로-->
                            <li class="page-item">
                                <a class="page-link" href="<%= request.getContextPath() %>/advice/qna/search?currentPage=<%= maxPage %>&searchKey=<%=searchKey %>&searchValue=<%= searchValue %>">&raquo;</a>
                            </li>
                            <% } %>
                        </ul>
                    	</div>
